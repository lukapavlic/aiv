...
public class BankAccountDBDao implements BankAccountDao {
    ...
    private static BankAccountDBDao inst;

    private BankAccountDBDao() {
        try {
    ...
    public static BankAccountDBDao getInstance() {
        if (inst==null) inst=new BankAccountDBDao();
        return inst;
    }
    ...
    public Person findPerson(int id) {
        System.out.println("DAO: searching "+id);
        Person ret = null;
    ...
    public Person savePerson(Person o) {
        System.out.println("DAO: saving "+o);
        Connection conn=null;
        try {
            conn=getConnection();
    ...
    public boolean bankAccountExists(String iban) {
        System.out.println("DAO: finding "+iban);
        boolean ret = false;
        Connection conn=null;
        try {
            conn=getConnection();
    ...
    public BankAccount findBankAccount(String iban, boolean  sTransakcijami) {
        System.out.println("DAO: searching "+iban);
    ...
    public void saveBankAccount(BankAccount br) throws BankAccountAlreadyExistException, IbanMissingException {
        System.out.println("DAO: saving "+br);
    ...
    public void saveTransaction(Transaction t) {
        System.out.println("DAO: saving "+t);
        Connection conn=null;
        try {
            conn=getConnection();
    ...
    public List<Transaction> getAllTransactions(String iban) {
        System.out.println("DAO: searching for transactions "+iban);
    ...
    public Map<String, BankAccount> getAll() {
        System.out.println("DAO: finding all bank accounts");
