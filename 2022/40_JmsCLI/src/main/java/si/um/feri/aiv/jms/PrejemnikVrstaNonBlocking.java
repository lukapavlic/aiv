...
public class PrejemnikVrstaNonBlocking implements MessageListener {
	...
	PrejemnikVrstaNonBlocking() throws Exception {
	...
	public static void main(String[] args) throws Exception {
		PrejemnikVrstaNonBlocking p=new PrejemnikVrstaNonBlocking();
		p.prejemajSporocila();
		Thread.sleep(60_000);
		p.konecPrejemanja();
	}
