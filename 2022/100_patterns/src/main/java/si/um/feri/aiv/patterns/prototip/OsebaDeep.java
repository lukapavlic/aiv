...
public class OsebaDeep implements Cloneable {

	public OsebaDeep() {
		this("", "","");
	}

	public OsebaDeep(String ime, String priimek, String email) {
		this.email = email;
		this.ime = ime;
	...
	public OsebaDeep(String ime, String priimek, String email, int id) {
		this.email = email;
		this.ime = ime;
		this.priimek = priimek;
		datumVpisa=new GregorianCalendar();
	...
	public Object clone() throws CloneNotSupportedException {
		OsebaDeep od=(OsebaDeep)super.clone();
		
		List<Kontakt> kontaktiRet=new ArrayList<Kontakt>();
		for (Kontakt k:getKontakti())
			kontaktiRet.add((Kontakt)k.clone());
		
		od.setKontakti(kontaktiRet);
		return od;
	}
