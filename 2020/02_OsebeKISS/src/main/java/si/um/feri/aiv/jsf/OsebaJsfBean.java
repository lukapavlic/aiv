...
import si.um.feri.aiv.ejb.OsebaMemoryDao;
import si.um.feri.aiv.ejb.OsebaMySqlDao;
...
public class OsebaJsfBean implements Serializable {
	...
	Logger log=LoggerFactory.getLogger(OsebaJsfBean.class);

//	private OsebaDao dao=OsebaMySqlDao.getInstance(); 
